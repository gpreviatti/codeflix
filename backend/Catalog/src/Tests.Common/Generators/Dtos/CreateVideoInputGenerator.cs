...
public class CreateVideoInputGenerator : VideoGenerator
{
    public static CreateVideoInput CreateValidInput(
    ...
    public static CreateVideoInput CreateValidInputWithAllImages() => new(
        GetValidTitle(),
        GetValidDescription(),
        GetValidYearLaunched(),
        GetRandomBoolean(),
    ...
    public static CreateVideoInput CreateValidInputWithAllMedias() => new(
        GetValidTitle(),
        GetValidDescription(),
        GetValidYearLaunched(),
        GetRandomBoolean(),
